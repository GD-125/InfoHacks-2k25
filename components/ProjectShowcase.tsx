...
const projects = [
  {
    ...
    details: 'This project aims to develop an AI-powered health assistant that can provide personalized health advice and perform symptom analysis.',
    expectedOutcome: 'A fully functional AI chatbot capable of answering health-related questions, analyzing symptoms, and providing personalized health recommendations.',
    coordinator: {
      name: 'Dr. Emily Chen',
      phone: '+1234567890',
      whatsapp: '+1234567890'
  ...
  },
  {
    ...
    expectedOutcome: 'A smart traffic management system that can significantly reduce congestion and improve urban mobility.',
    coordinator: {
  ...
  },
  {
    ...
    expectedOutcome: 'An engaging AR language learning app that makes language acquisition more intuitive and interactive.',
    coordinator: {
      name: 'Prof. David Lee',
      phone: '+1234567893',
      whatsapp: '+1234567893'
  ...
  },
  {
    ...
    image: '/placeholder.svg?height=200&width=300',
    details: 'This project focuses on developing a comprehensive platform for managing renewable energy sources in smart grids.',
    expectedOutcome: 'An intelligent energy management system that maximizes the use of renewable energy and reduces carbon footprint.',
    coordinator: {
  ...
  },
  {
    ...
    expectedOutcome: 'A robust threat detection system capable of identifying and neutralizing cyber attacks in real-time.',
    coordinator: {
  ...
  },
  {
    ...
    expectedOutcome: 'An engaging VR education platform that improves student understanding and retention across various subjects.',
    coordinator: {
      name: 'Dr. VR Educator',
      phone: '+1234567896',
      whatsapp: '+1234567896'
  ...
  },
  {
    ...
    expectedOutcome: 'An intelligent farming solution that improves crop yields and reduces resource usage through precise monitoring and analysis.',
    coordinator: {
      name: 'Prof. Agri Tech',
      phone: '+1234567897',
      whatsapp: '+1234567897'
  ...
  },
  {
    ...
    expectedOutcome: 'A sophisticated recommendation system that helps healthcare providers make more informed and tailored treatment decisions.',
    coordinator: {
  ...
  },
  {
    ...
    expectedOutcome: 'A sophisticated AUV capable of conducting underwater research and exploration with minimal human intervention.',
    coordinator: {
  ...
  },
  {
    ...
    image: '/placeholder.svg?height=200&width=300',
    details: 'This project aims to integrate emotion recognition into virtual assistants for more empathetic interactions.',
...
const ProjectShowcase = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-b from-gray-900 via-purple-900 to-gray-800 dark:from-gray-900 dark:via-purple-950 dark:to-gray-900">
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              className="bg-gray-800 dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300"
            >
                  ...
                  {expandedProjects.includes(project.id) && (
                    ...
                    >
                      ...
                      <motion.a
                        ...
                        className="block w-full text-center bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 transition-colors duration-300 mt-4"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      >
                        Register Now
